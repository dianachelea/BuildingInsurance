...
{
    public sealed class GetPolicyReportValidator : PaginatedQueryValidator<GetPolicyReportQuery>
    {
        public GetPolicyReportValidator()
        { 
            ...
            When(x => x.Filters is not null, () =>
            {
                ...
                RuleFor(x => x.Filters.Status)
                    .Must(s => s == PolicyStatusContract.Active
