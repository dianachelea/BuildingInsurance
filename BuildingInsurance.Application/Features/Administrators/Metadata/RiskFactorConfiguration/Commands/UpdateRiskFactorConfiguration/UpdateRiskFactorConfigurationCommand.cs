...
{
    public sealed class UpdateRiskFactorConfigurationCommand : ICommand<Result<RiskFactorConfigurationDto>>, IRiskFactorTargetRequest
    {
        public Guid Id { get; set; }
        public RiskFactorLevelContract Level { get; set; }
        public Guid? ReferenceId { get; set; }
        public BuildingTypeContract? BuildingType { get; set; }
